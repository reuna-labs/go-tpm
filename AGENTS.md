...
go-tpm fork on the nv-extend branch — Go TPM access with the NV-extend behaviour the Reuna attestation path needs.

## Where this repo sits

`~/reuna/trust/go-tpm` — the `trust/` group (Reuna trust components and the signed wire contracts).
